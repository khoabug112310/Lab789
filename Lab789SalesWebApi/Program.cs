...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Lab789 Sales Web API", Version = "v1" });
...
var imagesFolder = Path.Combine(app.Environment.ContentRootPath, "wwwroot", "images");
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Lab789 Sales Web API v1");
    });
}
